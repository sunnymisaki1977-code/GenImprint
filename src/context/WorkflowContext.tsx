...
interface WorkflowContextType {
  ...
  activeView: "workflow" | "export" | "vision" | "suno" | "social-vision";
  setActiveView: (view: "workflow" | "export" | "vision" | "suno" | "social-vision") => void;
  isUnlocked: boolean;
...
export const WorkflowProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [activeView, setActiveView] = useState<"workflow" | "export" | "vision" | "suno" | "social-vision">("workflow");
