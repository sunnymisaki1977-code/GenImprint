...
---
### 任務一：動態分割構圖 (Dynamic Segmented Layout), 美式漫畫跨頁插圖 (Comic Book Splash Page with Insets), 蒙太奇資訊圖表 (Montage Infographic) Prompt (Midjourney / Imagen)
...
- 史詩構圖：Dynamic Segmented Layout, Comic Book Splash Page with Insets, Montage Infographic (將你萃取的4-5個場景分割在同一畫面中).
...
### 🎨 第一部分：【視覺 Prompt 16:9】
English: A masterpiece neo-Chinese fantasy illustration of ${theme}, Dynamic Segmented Layout, Comic Book Splash Page with Insets, Montage Infographic with distinct epic panels. The background is divided into panels: [描繪**（主角名稱）**在不同人生階段或不同時空的關鍵場景。]. Traditional Texture: colorful ink wash, thick impasto ink, rice paper texture. Modern Fantasy Effects: energy flow, golden particles crossing between panels. Cinematic Render: cinematic lighting, strong chiaroscuro, 8k, ultra-detailed --ar 16:9 --v 6.0 --style raw

### 🎨 第一部分：【視覺 Prompt 9:16】
English: A masterpiece neo-Chinese fantasy illustration of ${theme}, vertical scroll format, Dynamic Segmented Layout, Comic Book Splash Page with Insets, Montage Infographic stacked vertically. The background is divided by shattered glass effects into epic scenes: [描繪**（主角名稱）**在不同人生階段或不同時空的關鍵場景。]. Traditional Texture: colorful ink wash, rice paper texture. Modern Fantasy Effects: neon ink, golden particles flowing upwards. Cinematic Render: dramatic backlighting, 8k, ultra-detailed --ar 9:16 --v 6.0 --style raw
